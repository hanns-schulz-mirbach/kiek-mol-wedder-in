...
$playerWhite_id = intval($_POST['playerWhite']);
$playerBlack_id = intval($_POST['playerBlack']);
$gameDate = DateTime::createFromFormat("d.m.Y", trim($_POST['gameDate']));
$resultValue = intval($_POST['result']);

$controller = new GameController();
$controller->instantiateSkeleton($game_id, $round_id, $playerWhite_id,
        $playerBlack_id, $gameDate, $resultValue);
