	...
	<div id="workarea">
		...
		<form action="report_create_confirmation.php" method="post">
			<input type="hidden" name="author"
				value=" <?php echo ($sessionManager->getUserId()); ?> "> <label
				for="publication_date">Publikationsdatum:</label> <input type="text"
				class="date-input" name="publication_date" id="publication_date"
				...
				<br /> <label for="report_title">Titel:</label> <input type="text"
				name="report_title" id="report_title" required> <br /> <br />
