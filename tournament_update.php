...
<body>
	...
	<div id="workarea">
		...
		<article>
			<h1>Aktualisierung Turnierdaten</h1>
			<?php

echo ("<form action='tournament_update_confirmation.php?id=" .
         $tournament->getId() . "' method='post'>");
echo ($formatter->getTournamentUpdateForm($tournament));
