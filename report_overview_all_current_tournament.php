...
echo ("<h1>Alle Berichte " . $currentTournament->getTournamentTitle() .
        "</h1>");

$reportController = new ReportController();
$reportController->deleteAllObsoleteReports();
$reports = $reportController->getReportsForCurrentTournament();
$formatter = new Formatter();
echo ($formatter->getAllReportsAsTableForUpdate($reports));
echo ("<br />");
